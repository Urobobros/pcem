...
* SB 16 - 16 bit stereo
  * Mixer register `0x48` (or `0x90` on some utilities) enables a simple
    "Surround" effect, similar to Creative's 3D Stereo enhancement.
    See `docs/ct3dse_test.md` for a quick test using Creative's CT3DSE tool.
