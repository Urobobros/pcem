...
- [x] Zkontrolovat, že BIOS nepřepisuje sám sebe, pokud je RAM odpojena
...
- [x] Při volání `WHvRunVirtualProcessor()` logovat GPA, hodnotu CS:IP,
  informaci o použité oblasti (RAM/ROM) a `exit_reason`.
- [x] Před spuštěním CPU vždy namapovat celou RAM od GPA 0x000000 po její
  velikost.
