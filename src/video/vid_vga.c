...
static int vga_available() { return rom_present("ibm_vga.bin"); }
...
device_t vga_device = {"VGA", 0, vga_init, vga_close, vga_available, vga_speed_changed, vga_force_redraw, vga_add_status_info};
device_t ps1vga_device = {"PS/1 VGA",         0, ps1vga_init, vga_close, vga_available, vga_speed_changed, vga_force_redraw,
                          vga_add_status_info};
