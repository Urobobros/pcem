...
void i440bx_init() {
        ...
        card_i440bx[0x00] = 0x86;
        card_i440bx[0x01] = 0x80; /*Intel*/
        card_i440bx[0x02] = 0x92;
        card_i440bx[0x03] = 0x71; /*82441FX*/
        card_i440bx[0x04] = 0x06;
        card_i440bx[0x05] = 0x00;
        card_i440bx[0x06] = 0x00;
        card_i440bx[0x07] = 0x02;
        card_i440bx[0x08] = 0x02; /*B1 stepping*/
        card_i440bx[0x09] = 0x00;
        card_i440bx[0x0a] = 0x00;
        card_i440bx[0x0b] = 0x06;
